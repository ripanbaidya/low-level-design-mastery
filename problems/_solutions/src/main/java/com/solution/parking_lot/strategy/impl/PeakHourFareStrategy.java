package com.solution.parking_lot.strategy.impl;

import com.solution.parking_lot.entities.Ticket;
import com.solution.parking_lot.strategy.FareStrategy;

import java.math.BigDecimal;
import java.time.LocalDateTime;

/**
 * Peak-hour surcharge: 50% extra if a vehicle entered during peak hours.
